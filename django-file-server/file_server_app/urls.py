...
from .views import serve_file, serve_file_secure, display_user_input, display_user_input_secure, fetch, fetch_safe
...
urlpatterns = [
    ...
    path('fetch-secure', fetch_safe, name='fetch-secure'),
